    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">Comment (Pending)</h4>
                <a href="comment-approved.php" class="btn btn-primary btn-xs">Approved Comments</a>
            </div>
        </div>
                        ...
                        <tbody>
                            ...
                            foreach ($result as $row) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="comment-make-approved.php?id=<?php echo safe_data($row['comment_id']); ?>" class="btn btn-primary btn-xs btn-block">Make Approved</a>
