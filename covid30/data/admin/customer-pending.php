    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">Pending Customers</h4>
                <a href="customer-active.php" class="btn btn-primary btn-xs">Active Customers</a>
            </div>
        </div>
                        ...
                        <tbody>
                            ...
                            foreach ($result as $row) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="customer-change-status.php?id=<?php echo safe_data($row['customer_id']); ?>" class="btn btn-warning btn-xs btn-block" onClick="return confirm('Are you sure?');">Make Active</a>
                                    </td>
                                    <td>
