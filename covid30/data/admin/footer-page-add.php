...
if(isset($_POST['form1']))
{
    ...
    $statement = $pdo->prepare("INSERT INTO tbl_footer_page (
                        page_id,
                        order1
                    ) VALUES (?,?)");
    ...
    $success_message = 'Footer Page is added successfully!';
}
?>
    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="breadcrumbs-area clearfix">
                <h4 class="page-title pull-left">Add Footer Page</h4>
                    ...
                    <form action="" method="post">
                        <div class="form-group">
                            ...
                            <select name="page_id" class="form-control select2">
                                ...
                                foreach ($res as $row) {
                                    ?>
                                    <option value="<?php echo safe_data($row['page_id']); ?>"><?php echo safe_data($row['page_name']); ?></option>
                                    <?php
                                }
                                ?>
                            </select>
